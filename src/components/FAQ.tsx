...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 md:py-40 px-6 md:px-12 bg-gradient-to-br from-neutral-50 via-white to-primary-50">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed">
            ...
            <a href="mailto:hello_wishwing@fidcent.com" className="text-primary-600 hover:underline">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full font-semibold text-sm transition-all duration-300 ${
                activeCategory === category
                  ...
                  : 'bg-white text-neutral-600 border border-neutral-200 hover:border-primary-600'
              }`}
            >
              {category}
            </button>
        ...
        <div className="space-y-4">
          {filteredFAQs.map((faq, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl border border-neutral-200/50 overflow-hidden hover:border-primary-600 hover:shadow-strong transition-all duration-300"
            >
              <button
              ...
              >
                <div className="flex-1 pr-4">
                  <div className="text-xs text-primary-600 font-semibold mb-1">{faq.category}</div>
        ...
        <div className="mt-16 text-center p-8 bg-gradient-to-r from-primary-600 to-accent-600 rounded-3xl shadow-strong">
          <h3 className="text-2xl font-bold text-white mb-3">Still Have Questions?</h3>
          <p className="text-white/90 mb-6">Our support team is here to help!</p>
          <a
            href="mailto:hello_wishwing@fidcent.com"
            className="inline-block px-8 py-3 bg-white text-primary-600 font-bold rounded-full hover:bg-neutral-100 transition-all duration-300 hover:scale-105 shadow-medium"
          >
            Contact Support
          </a>
        </div>
